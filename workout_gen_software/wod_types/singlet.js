const mongodb = require('../../database/database'),
      ...
      chooseExercises = require('../helpers/wod/chooseExercises');

module.exports = {

  generate: (user, wod, exercises) => {
    console.log('singlet', wod);
    /*
      1. choose one exercise
        - wod.exercises
      2. choose reps based on number of rounds already assigned in the wod. 
        - will be between 7-10 rounds
        - wod.reps
      3. wod.run = false
    ...
    */
    ...
    wod.exercises = chooseExercises.setUp(user.muscleGrp, exercises, 1);
    console.log('wod',wod);
  }
